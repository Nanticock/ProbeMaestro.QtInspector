...
public:
    ...
    struct Sender
    {
        Sender(QObject *receiver, QObject *sender, int signal) : receiver(receiver), sender(sender), signal(signal)
        {
            if (receiver)
            {
    ...
    */
    ...
    static inline bool disconnect(const typename QtPrivate::FunctionPointer<Func1>::Object *sender, Func1 signal,
                                  const typename QtPrivate::FunctionPointer<Func2>::Object *receiverPrivate, Func2 slot);
    static QMetaObject::Connection connectImpl(const QObject *sender, int signal_index, const QObject *receiver, void **slot,
                                               QtPrivate::QSlotObjectBase *slotObj, Qt::ConnectionType type, const int *types,
...
inline void QObjectPrivate::checkForIncompatibleLibraryVersion(int version) const
{
    ...
    {
        qFatal("Cannot mix incompatible Qt library (%d.%d.%d) with this library (%d.%d.%d)", (version >> 16) & 0xff, (version >> 8) & 0xff,
               version & 0xff, (QObjectPrivateVersion >> 16) & 0xff, (QObjectPrivateVersion >> 8) & 0xff, QObjectPrivateVersion & 0xff);
    }
#endif
}
...
class QPrivateSlotObject : public QSlotObjectBase
{
                                                       ...
                                                       Qt::ConnectionType type)
{
    ...
    return QObject::connectImpl(
        sender, reinterpret_cast<void **>(&signal), receiverPrivate->q_ptr, reinterpret_cast<void **>(&slot),
                                ...
                                const typename QtPrivate::FunctionPointer<Func2>::Object *receiverPrivate, Func2 slot)
{
    ...
    Q_STATIC_ASSERT_X((QtPrivate::CheckCompatibleArguments<typename SignalType::Arguments, typename SlotType::Arguments>::value),
                      "Signal and slot arguments are not compatible.");
    return QObject::disconnectImpl(sender, reinterpret_cast<void **>(&signal), receiverPrivate->q_ptr, reinterpret_cast<void **>(&slot),
...
public:
    ...
    QMetaCallEvent(ushort method_offset, ushort method_relative, QObjectPrivate::StaticMetaCallFunction callFunction, const QObject *sender,
                   int signalId, void **args, QSemaphore *semaphore);
    ...
    inline const void * const *args() const
    {
        return d.args_;
    }
    inline void **args()
    ...
    inline const int *types() const
    {
        return reinterpret_cast<int *>(d.args_ + d.nargs_);
    }
    inline int *types()
    {
        return reinterpret_cast<int *>(d.args_ + d.nargs_);
